        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-5">
          <div className=" mb-3 md:w-[270px] md:h-[390px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300 ">
            ...
            <div>
              ...
              <p className="px-2 text-wrap text-gray-700">
                The Hospital Management System is built with Express.js,
                React.js, and PostgreSQL, designed to enhance patient
                experiences.
              </p>
            </div>
          ...
          <div className=" mb-3 md:w-[270px] md:h-[390px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300 ">
            ...
            <div>
              ...
              <p className="px-2 text-wrap text-gray-700">
                The Skill up is built with Express.js, React.js with redux , and
                PostgreSQL.It is a modern online learning environment designed
          ...
          <div className=" mb-3 md:w-[270px] md:h-[390px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300 ">
            ...
            <div>
              ...
              <p className="px-2 text-wrap text-gray-700">
                Developed user-friendly web application using HTML, CSS, and
                JavaScript to enable convenient search for movies and dramas by
                title.
              </p>
            </div>
            <div className=" px-6 py-4 space-x-3 justify-around">
          ...
          <div className=" mb-3 md:w-[270px] md:h-[390px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300 ">
            ...
            <div>
              ...
              <p className="px-2 text-wrap text-gray-700">
                InsightInk is a responsive web application, designed with a
                minimalist aesthetic, serves as a freelance publishing platform
          ...
          <div className=" mb-3 md:w-[270px] md:h-[390px] border-[2px] rounded-lg shadow-lg p-1 cursor-pointer hover:scale-110 duration-300 ">
            ...
            <div>
              ...
              <p className="px-2 text-wrap text-gray-700">
                Created an interactive Tic Tac Toe game using HTML, CSS, and
                JavaScript, featuring responsive design and both single-player
